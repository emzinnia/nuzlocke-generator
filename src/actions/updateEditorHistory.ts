...
export const initEditorHistory = (present: unknown): Action<INIT_EDITOR_HISTORY, unknown> => {
    return {
...
export interface UpdateEditorHistoryAction extends Action<UPDATE_EDITOR_HISTORY, unknown> {
...
export type undoEditorHistory = () => Action<UNDO_EDITOR_HISTORY, unknown>;
export const undoEditorHistory = (): Action<UNDO_EDITOR_HISTORY, unknown> => {
    return {
...
export type redoEditorHistory = () => Action<REDO_EDITOR_HISTORY, unknown>;
export const redoEditorHistory = (): Action<REDO_EDITOR_HISTORY, unknown> => {
    return {
...
export type jumpToHistoryState = (index: number) => Action<JUMP_TO_HISTORY_STATE, unknown>;
export const jumpToHistoryState = (index: number): Action<JUMP_TO_HISTORY_STATE, unknown> => {
    return {
