    ...
    return (
        <div className="p-6">
            <div className="flex items-center gap-3 mb-4">
                ...
                <button
                    className="ml-auto inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                    title="Download run"
                >
